...
async function runListPage() {
  ...
  const checkIn = moment(
    document.querySelector('.--checkin-field .sb-date-field__display').innerText
  );
  const checkOut = moment(
    document.querySelector('.--checkout-field .sb-date-field__display').innerText
  );
