    ...
    loadEstimateAnnotation(
      {
        ...
        insertAfterElement: document.querySelector('.og-offer') || document.querySelector('.productmarquee__media ~ div .grid:nth-child(4)') || document.querySelector('.product-details__review') || document.querySelector('.buybox > div:nth-child(4)') || document.querySelector('div.productmarquee * div.grid[data-lg-name=Pricing]')
      },
      {
        waitForFullRun: true,
