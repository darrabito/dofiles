...
class CashBack extends Component {
  ...
  render() {
    ...
    const showFTUX =
      _.get(this.props.view, 'showFTUX') &&
      !_.get(this.props, 'events.hasSeenCashbackFtux', false) &&
      !_.get(this.props, 'view.hasCoupons');
    ...
    return (
      <div
        ...
        }  ${this.state.fullScreen || showFTUX ? 'fullscreen' : ''} ${backgroundOpacityClass} ${
          ...
          {({opacity, y, tabX, tabOpacity}) =>
            !renderMiniCashbackNotificationTab ? (
              <div
                ...
                } cashback-notification ${showFTUX ? 'ftux-notif' : ''}`}
                style={{
                  transform: showFTUX
                    ? `translate3d(-50%, ${y - 50}%, 0)`
                    : `translate3d(0,${y}%,0)`,
                  opacity: `${opacity}`,
                ...
                {accountGateType ? (
                  ...
                  <CashBackResolve
                    ...
                    hasSeenFTUX={_.get(this.props, 'events.hasSeenCashbackFtux', false)}
                    onUserClosePopup={this.onUserClosePopup.bind(this)}
                    deweyResult={_.get(this.props.view, 'deweyResult')}
                    setSeenCashbackFtux={this.setSeenCashbackFtux.bind(this)}
                  />
                )}
              </div>
            ) : (
  ...
  setSeenCashbackFtux() {
    setSeenNotificationTooltip('hasSeenCashbackFtux');
  }
